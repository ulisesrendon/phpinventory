...
<p>Las clases son el plano en donde se detallan las características de los objetos.</p>
...
<p>Ahora tenemos una clase producto que agrupa y oculta los datos, simplemente definimos una variable para cada dato requerido y declaramos el tipo de dato, y antes de cada variable usamos la palabra <strong>private</strong> que es el indicativo de que el dato debe estar oculto.</p>

<p>Ciertamente podríamos haber definido un arreglo asociativo con estos datos.</p>

<p>Pero ¿como evitas que los datos sean modificados por tus algoritmos o por otros módulos?, ó ¿como evitas que si los valores que van a ser modificados no se corrompan?</p>
...
<p>Para resolver estas cuestiones crearemos las funciones que definirán el comportamiento interno del producto.</p>

<p>Vamos a modificar el código anterior y a añadir mecanismos para poder leer los datos del producto y al final del código vamos a imprimirlos para comprobar que realmente estamos accediendo a ellos.</p>
...
<p>Hay que recordar que hacemos todo esto para poder proteger los datos para que no sean modificados, si ponemos atención al código, no hay forma alguna de modificar los valores del producto mientras se ejecuta el programa, además</p>


<p>Los datos encapsulados en objetos se conocen como propiedades y las funciones encapsuladas en objectos se conocen como métodos.</p>

<p>Al igual que con los datos, también se puede controlar el nivel de acceso desde el exterior a los métodos, permitiendo libre acceso solo a algunas funcionalidades y manteniendo el resto oculto.</p>
