<div class="navblock-prevnext">
    ...
    <a class="navblock-prevnext-link prev" href="<?php echo $PrevContent->url ?>" title="<?php echo $NextContent->title ?>"><span class="navblock-prevnext-arrow prev">←</span><span class="navblock-prevnext-anchor prev"><?php echo $PrevContent->title ?></span></a>
    <?php } ?>
